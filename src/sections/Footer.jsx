// Footer — quiet, minimal. Copyright, quick links, back-to-top, and a warm sign-off.
    ...
    <footer className="bg-espresso border-t border-white/8 px-6 md:px-12 py-10">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 text-white/35 font-sans text-xs">
          ...
          <span className="font-hand text-caramel/40 text-sm">Thanks for stopping by.</span>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-white/30 hover:text-caramel transition-colors">
            <Github size={16} />
          </a>
